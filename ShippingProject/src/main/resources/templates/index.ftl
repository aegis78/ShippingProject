  ...
  <body class="home">
		...
		<header class="header" role="banner">
			<div class="wrap">
				<!-- Logo -->
				<div class="logo">
					<a href="index.html" title="Bulk Match"><img src="images/transfers.jpg" alt="Bulk Match" /></a>
				</div>
				<!-- //Logo -->
				...
				<nav role="navigation" class="main-nav">
					<ul>
						...
						<li><a href="index.html" title="Cargo">Cargo</a></li>
						<li><a href="index.html" title="Vessel">Vessel</a></li>
						<li><a href="index.html" title="Company">Company</a>
							<ul>
								<li><a href="#" title="Post">About us</a></li>
								<li><a href="#" title="Post">Matching Info</a></li>
								<li><a href="#" title="Post">Cargo Service</a></li>
								<li><a href="#" title="Post">Vessel Service</a></li>
							</ul>
						</li>
						<li><a href="index.html" title="Contact">Contact</a></li>
						<li><a href="index.html" title="Notice">Notice</a></li>
						<li> | </li>
						<li><a href="index.html" title="Login">Login</a></li>
						<li><a href="index.html" title="Sign up">Sign up</a></li>
					</ul>
				</nav>
				<!-- //Main Nav -->
			</div>
		...
		<div class="wrap">
			<div class="row">
				...
				<article class="one-half">
					<h6>About us</h6>
					<p>Although madcloud is a profit-making company, it is a solid organization with people who share the same desire to succeed in the business. We aim to be a good community where we can live together. Through continuous innovation, creative thinking, infinite passion and social contribution, we can communicate with the world today. I dream of a new world.</p>
				</article>
				<!-- //Column -->
				...
				<article class="one-fourth">
					...
					<p class="contact-data"><span class="ico phone"></span> +1 5678 1234 1234</p>
					<p class="contact-data"><span class="ico email"></span> <a href="mailto:help@transfers.com">help@bulkmatching.com</a></p>
				</article>
				<!-- //Column -->
			...
			<div class="copy">
				<p>Copyright 2017, madcloud Co., Ltd. All rights reserved. </p>
